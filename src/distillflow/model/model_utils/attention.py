...
def print_attn_implementation(config: "PretrainedConfig") -> None:
    ...
    if attn_implementation == "flash_attention_2":
        logger.warning("Using FlashAttention-2 for faster training and inference.")
    elif attn_implementation == "sdpa":
        logger.warning("Using torch SDPA for faster training and inference.")
    else:
        logger.warning("Using vanilla attention implementation.")
